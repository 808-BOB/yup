      ...
      <CardContent className="bg-card p-6 rounded-b-xl">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="text-center mb-6 p-4 rounded-lg" style={{ backgroundColor: brandColors.primary + '10' }}>
            ...
            {responseType === 'maybe' && (
              <div>
                <h3 className="text-xl font-bold text-foreground mb-2">So, you have a hard time with commitments? 😅</h3>
                <p className="text-foreground">Sigh... please let us know the info below regardless!</p>
              </div>
            )}
            {responseType === 'nope' && (
              <div>
                <h3 className="text-xl font-bold text-foreground mb-2">Oh no! 😞</h3>
                <p className="text-foreground">Sorry that it won't work out! Please tell us who you are so we know!</p>
              </div>
            )}
          </div>
