        ...
        {selectedTab === 'styleguide' && (
          <div className="space-y-6">
            ...
            {styleGuideTab === 'spacing' && (
              <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-6">Spacing System</h3>
                <div className="space-y-4">
            ...
            {styleGuideTab === 'layout' && (
              <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-6">Layout & Grid</h3>
            ...
            {styleGuideTab === 'page-layouts' && (
              <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-6">Page Layouts & Wireframes</h3>
            ...
            {styleGuideTab === 'interactions' && (
              <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-6">Interactions & States</h3>
            ...
            {styleGuideTab === 'tokens' && (
              <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-6">Design Tokens</h3>
