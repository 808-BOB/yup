  ...
  const updateEventMutation = useMutation({
    mutationFn: async (data: FormValues) => {
      ...
      const updateData = {
        ...
        maxGuestsPerRsvp: data.maxGuestsPerRsvp ? Number(data.maxGuestsPerRsvp) : 1,
        ...
        rsvpVisibilityThreshold: data.rsvpVisibilityThreshold ? Number(data.rsvpVisibilityThreshold) : 0,
